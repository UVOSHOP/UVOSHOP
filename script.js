document.addEventListener('DOMContentLoaded', () => {
  ...
  if (!gameId) {
    ...
    function createGameCard(game) {
      ...
      // Penting: Menggunakan 'game-item' agar sesuai dengan HTML statis dan pencarian
      card.className = 'game-item'; // Pastikan ini 'game-item' atau class yang sama dengan elemen game di HTML Anda
    ...
    fetch('games.json')
      ...
      .then(games => {
        ...
        // ===========================================
        // START FITUR SEARCH YANG DITAMBAHKAN
        // ===========================================
        searchInput.addEventListener('input', () => {
          const term = searchInput.value.toLowerCase(); // Ambil input dan ubah ke lowercase
          
          // Iterasi semua kontainer kategori
          Object.values(categories).forEach(container => {
            // Ambil semua elemen anak (card game) dalam kontainer ini
            // Pastikan elemen game yang dibuat secara dinamis memiliki class 'game-item' atau 'game-card'
            // Sesuaikan selektor di bawah ini jika elemen game Anda menggunakan class lain
            Array.from(container.children).forEach(card => {
              // Asumsikan nama game ada di dalam tag <h3> di dalam card
              const nameElement = card.querySelector('h3');
              if (nameElement) { // Pastikan elemen <h3> ditemukan
                const name = nameElement.innerText.toLowerCase();
                // Tampilkan atau sembunyikan card berdasarkan kecocokan pencarian
        ...
        // ===========================================
        // END FITUR SEARCH YANG DITAMBAHKAN
        // ===========================================
